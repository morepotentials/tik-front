...
export default {
  ...
  setup(props, { emit }) {
    const tourismusRegionen = [
      ...
      {
        Region: "Anhalt-Dessau-Wittenberg",
        Institution: "Industrie- und Filmmuseum (IFM) Wolfen",
        PLZ: "06766",
      ...
      {
        Region: "Anhalt-Dessau-Wittenberg",
        Institution: "Kupferhammer Thießen",
        PLZ: "06868",
      ...
      {
        Region: "Halle-Saale-Unstrut",
        Institution: "Deutsches-Chemie-Museum Merseburg",
        PLZ: "06217",
        Ortsname: "Merseburg",
      ...
      {
        Region: "Halle-Saale-Unstrut",
        Institution: "Salinemuseum Halle",
        PLZ: "06108",
        Ortsname: "Halle (Saale)",
      ...
      },
      {
        ...
        Oeffnungszeit: "10-17.00 Uhr",
        AktivitätTIK_2024:
          '11.00 Uhr Treffpunkt Alte Schule\nRundgang unter dem Motto:\n"Auf den Spuren vergessener Industrieanlagen"\n\n14.00 - 16.00 Uhr\nMuseum "500 Jahre Industriegeschichte Rothenburg"\n\n14.00 Uhr Vortrag im Museum\n',
        Webseite: "www.500-indu-rothenburg.de",
        Infos: "",
        TeilnahmeBestätigt: "13.04.2024",
      },
      {
        Region: "",
        Institution: "",
